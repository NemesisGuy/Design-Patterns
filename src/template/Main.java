...
/*
*
* The AbstractClass defines the template method (templateMethod) that calls a series of steps.
...
In the Main class, we create instances of ConcreteClassA and ConcreteClassB and execute the template method for each of them.
* */
public class Main {
