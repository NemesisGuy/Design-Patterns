...
CreditCardPayment and PayPalPayment are concrete strategy classes that implement the PaymentStrategy interface.
* They provide specific implementations of the pay method.

The ShoppingCart class represents the context.
*  It has a paymentStrategy field and a method to set the strategy and perform the checkout.

In the Main class, we create instances of CreditCardPayment and
* PayPalPayment and set them as the payment strategy for the shopping cart.
*
